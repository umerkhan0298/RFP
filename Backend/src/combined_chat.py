...
def functionality_of_functional_hierarchy(llm, history):
    ...
    'In functional details make sure every tasks contain summary section and every sub tasks till last sub tasks every heading should contain a summary section where it will be a summary of the detail description. The name of heading will be summary and description of sepcific task or sub task',
